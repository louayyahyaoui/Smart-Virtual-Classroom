      ...
      <Segment basic textAlign="center">
        {(finalTask[0].grade * 100) / pts > 70 ? (
          ...
          <>
            ...
            <p>
              Sorry {finalTask[0].student.name} next Time . {finalTask[0].grade}{" "}
              / {pts} points.
            </p>
          </>
        )}
                  ...
                  <Table.Body>
                    <Table.Row
                      ...
                      negative={
                        ...
                        quiz.foptionA === finalTask[0].listReponse[index]
                      }
                    >
                      <Table.Cell>
                        {quiz.foptionA === finalTask[0].listReponse[index] &&
                    ...
                    <Table.Row
                      ...
                      negative={
                        ...
                        quiz.foptionB === finalTask[0].listReponse[index]
                      }
                    >
                      <Table.Cell>
                        {quiz.foptionB === finalTask[0].listReponse[index] &&
                    ...
                    <Table.Row
                      ...
                      negative={
                        ...
                        quiz.foptionC === finalTask[0].listReponse[index]
                      }
                    >
                      <Table.Cell>
                        {quiz.foptionC === finalTask[0].listReponse[index] &&
                    ...
                    <Table.Row
                      ...
                      negative={
                        ...
                        quiz.foptionD === finalTask[0].listReponse[index]
                      }
                    >
                      <Table.Cell>
                        {quiz.foptionD === finalTask[0].listReponse[index] &&
