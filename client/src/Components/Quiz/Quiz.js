...
import { Button, Segment, Progress, Divider, Modal } from "semantic-ui-react";
        ...
        {quizzes.length > 0 ? (
          <div>
            ...
            {cuurQuestion == quizzes.length - 1 ? (
              <Modal
                open={open}
                trigger={<Button onClick={() => handleOpen()} content="save" />}
                dimmer="inverted"
                size="tiny"
                closeIcon="close"
              >
                ...
                <Modal.Content>
                  ...
                  <p>
                    Once you press the Submit Button you cannot return to your
                    Quiz .
                  </p>
                </Modal.Content>
                <Modal.Actions>
