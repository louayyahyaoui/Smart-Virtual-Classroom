...
function replaceAllTextEmojis(text) {
  ...
  if (allEmojis) {
    ...
    allEmojis.forEach(emoji => {
      ...
      if (!style) return;
      text = replaceAll(text, emoji, "<img\n            style=\"".concat(style, "\"\n            data-emoji=\"").concat(emoji, "\"\n            src=\"").concat(TRANSPARENT_GIF, "\"\n          />"));
    });
  }
...
function replaceAllTextEmojiToString(inputEl, cleanedTextRef, placeholderEl, emitChange) {
  if (!inputEl) {
...
function handleKeydown(_ref) {
  ...
  return event => {
    ...
    if (typeof maxLength !== "undefined" && event.keyCode !== 8 && totalCharacters(inputEl) >= maxLength) {
      event.preventDefault();
    }

    if (event.keyCode === 13) {
      event.preventDefault();
      replaceAllTextEmojiToString(inputEl, cleanedTextRef, placeholderEl, emitChange);
...
function handleKeyup(replaceAllTextEmojiToStringDebounced) {
  return () => {
...
function InputEmoji(_ref, ref) {
  ...
  const cleanedTextRef = React.useRef("");
  ...
  const replaceAllTextEmojiToString = React.useCallback(() => {
  ...
  function getImage(emoji) {
    let shortNames = "".concat(emoji.short_names);
    shortNames = replaceAll(shortNames, ",", ", ");
    /** @type {HTMLSpanElement} */

    const emojiSpanEl = document.querySelector("[aria-label=\"".concat(emoji.native, ", ").concat(shortNames, "\"] > span")) || document.querySelector("[aria-label=\"".concat(emoji.id, "\"] > span"));
    ...
    return "<img style=\"".concat(style, "\" data-emoji=\"").concat(dataEmoji, "\" src=\"").concat(TRANSPARENT_GIF, "\" />");
  } // eslint-disable-next-line valid-jsdoc
  ...
  }, showPicker && /*#__PURE__*/React__default['default'].createElement(EmojiPicker$1, {
...
InputEmojiWithRef.propTypes = {
  ...
  onChange: PropTypes__default['default'].func,
  cleanOnEnter: PropTypes__default['default'].bool,
  ...
  keepOpenend: PropTypes__default['default'].bool,
