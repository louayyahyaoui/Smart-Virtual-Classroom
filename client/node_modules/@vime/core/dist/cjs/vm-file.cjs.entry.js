...
const File = class {
  ...
  initLazyLoader() {
    this.lazyLoader = new LazyLoader.LazyLoader(this.host, ['data-src', 'data-poster'], () => {
      if (withComponentRegistry.isNullOrUndefined(this.mediaEl))
        return;
  ...
  async getAdapter() {
    return {
      ...
      canPlay: async (type) => withComponentRegistry.isString(type) && (utils.audioRegex.test(type) || utils.videoRegex.test(type)),
