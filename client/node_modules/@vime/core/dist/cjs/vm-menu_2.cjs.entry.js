...
const Menu = class {
  ...
  focusController() {
    if (!withComponentRegistry.isUndefined(this.controller?.focusItem)) {
      this.controller?.focusItem();
    }
    else if (!withComponentRegistry.isUndefined(this.controller?.focusControl)) {
...
const MenuItem = class {
  ...
  onClick() {
    if (!withComponentRegistry.isNullOrUndefined(this.menu))
