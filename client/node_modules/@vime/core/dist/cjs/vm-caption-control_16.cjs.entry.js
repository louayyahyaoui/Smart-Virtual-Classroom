...
const withControlsCollisionDetection = require('./withControlsCollisionDetection-9b41fd9f.js');
...
const Controls = class {
  ...
  async setupPlayerListeners() {
    const player = await withComponentRegistry.findPlayer(this);
  ...
  render() {
    return (index.h(index.Host, { video: !this.isAudioView }, index.h("div", { style: {
        ...this.getPosition(),
