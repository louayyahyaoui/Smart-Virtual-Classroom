...
var setTransformOrigin = function setTransformOrigin(state) {
  state.elements.popper.style.setProperty(_utils.popperCSSVars.transformOrigin["var"], (0, _utils.toTransformOrigin)(state.placement));
};
/* -------------------------------------------------------------------------------------------------
...
var setArrowStyles = function setArrowStyles(state) {
  ...
  if ((_state$elements = state.elements) != null && _state$elements.arrow && overrides) {
    ...
    Object.assign(state.elements.arrow.style, (_Object$assign = {}, _Object$assign[overrides.property] = overrides.value, _Object$assign.width = _utils.popperCSSVars.arrowSize.varRef, _Object$assign.height = _utils.popperCSSVars.arrowSize.varRef, _Object$assign.zIndex = -1, _Object$assign));
    var vars = (_vars = {}, _vars[_utils.popperCSSVars.arrowSizeHalf["var"]] = "calc(" + _utils.popperCSSVars.arrowSize.varRef + " / 2)", _vars[_utils.popperCSSVars.arrowOffset["var"]] = "calc(" + _utils.popperCSSVars.arrowSizeHalf.varRef + " * -1)", _vars);
...
var getArrowStyle = function getArrowStyle(placement) {
  if (placement.startsWith("top")) {
    return {
      property: "bottom",
      value: _utils.popperCSSVars.arrowOffset.varRef
    };
  }
...
var setInnerArrowStyles = function setInnerArrowStyles(state) {
  ...
  Object.assign(inner.style, {
    ...
    background: _utils.popperCSSVars.arrowBg.varRef,
    top: 0,
    left: 0,
    width: "100%",
    height: "100%",
